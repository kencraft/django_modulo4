...
PUBLIC_KEY = 'afc00286675171c8df8cf2c789c48627'
PRIVATE_KEY = 'd2ecf8fa1bfc0de47e86e3a6c0833a98097f7898'
TS = 1
...
def get_comics(request):
    ...
    offset = int(offset)
    limit = int(limit)
    anteriores=offset-limit
    siguientes=offset+limit
    ...
    for i in range(len(id)):
        ...
        <td>
            <form action="http://localhost:8000/e_commerce/api/buy_comic/" method="post" , style ="visibility: {visibility};">
    ...
    <table style="width:100%">
        <tr>
            <td>
                <form action="http://localhost:8000/e_commerce/api/get_comics/" method="get" >
                    <input type="number" id="offset" name="offset" value="{anteriores}" style="visibility: hidden;">
                    <input type="submit" value="ANTERIORES" >
                </form>
            </td>

            <td>
                <form action="http://localhost:8000/e_commerce/api/get_comics/" method="get" >
                    <input type="number" id="offset" name="offset" value="{siguientes}" style="visibility: hidden;">
                    <input type="number" id="limit" name="limit" value="{limit}">
                    <input type="submit" value="SIGUIENTES" >
                </form>
            </td>
        </tr>
    </table>
